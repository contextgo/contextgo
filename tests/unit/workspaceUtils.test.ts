...
describe('workspace utils', () => {
  ...
  it('builds automation file paths for Unix-style workspaces', () => {
    expect(getWorkspaceAutomationPaths('/Users/demo/project')).toEqual({
      ...
      requirementsDir: '/Users/demo/project/.contextgo/requirements',
      requirementBindingsFile: '/Users/demo/project/.contextgo/requirements/bindings.json',
  ...
  it('builds automation file paths for Windows-style workspaces', () => {
    expect(getWorkspaceAutomationPaths('D:\\workspace\\project')).toEqual({
      ...
      requirementsDir: 'D:\\workspace\\project\\.contextgo\\requirements',
      requirementBindingsFile: 'D:\\workspace\\project\\.contextgo\\requirements\\bindings.json',
