...
vi.mock('../../src/common', () => ({
  ipcBridge: {
    ...
    acpConversation: {
      ...
      configureManagedRuntimeModel: makeChannel('configureManagedRuntimeModel'),
      listManagedRuntimeTokenGroups: makeChannel('listManagedRuntimeTokenGroups'),
      syncManagedRuntimeModelProvider: makeChannel('syncManagedRuntimeModelProvider'),
