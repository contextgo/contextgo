export const WORKSPACE_TOGGLE_EVENT = 'contextgo-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'contextgo-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'contextgo-workspace-has-files';
