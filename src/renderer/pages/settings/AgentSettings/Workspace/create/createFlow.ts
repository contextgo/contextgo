...
const RECOMMENDATION_PROFILES: RecommendationProfile[] = [
  ...
  {
    presetId: 'remotion-video-studio',
    keywords: [
      'remotion',
      'react video',
      'tsx video',
    ...
    recurrence: ['frequent', 'continuous'],
    reasons: ['Best fit for Remotion-native React video, Player embeds, SSR renders, and Lambda planning.'],
  },
  {
  ...
  {
    presetId: 'hyperframes-video-studio',
    keywords: [
      'hyperframes',
      'html',
      'html-to-video',
    ...
    styles: ['create', 'execute'],
    recurrence: ['frequent', 'continuous'],
    reasons: ['Best fit for deterministic HTML-to-video rendering with HyperFrames projects, manifests, and QC.'],
  },
  {
    presetId: 'visual-artifact-runner',
    keywords: [
      'deck',
      'pdf',
      'infographic',
    ...
    styles: ['create', 'execute'],
    reasons: ['Best fit for turning briefs, reports, and PDFs into decks, infographics, and handouts with QC.'],
  },
  {
