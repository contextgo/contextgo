...
const ChatWorkspace: React.FC<WorkspaceProps> = ({
  ...
  const refreshWorkspaceSlices = useCallback(async () => {
    try {
  ...
  const pasteHook = useWorkspacePaste({
    ...
    refreshWorkspace: refreshWorkspaceSlices,
  ...
  }, [conversation, conversation_id, refreshWorkspaceSlices]);
    ...
    <>
      ...
      >
        ...
        <MigrationModal
          ...
          showScheduleMigrationPrompt={migrationHook.showScheduleMigrationPrompt}
        ...
        {!isWorkspaceCollapsed && (
          <FlexFullContainer containerClassName='min-h-0'>
            ...
            <div className='flex min-h-0 flex-1 flex-col'>
              {currentView === 'changes' ? (
                !workspaceLoadDeferred ? (
                  <WorkspaceChanges
                    workspace={workspace}
                    reloadToken={workspaceReloadToken}
