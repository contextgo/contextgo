...
import type { ConnectorAuthType, ConnectorCategory, ConnectorExperienceTab, ConnectorResource, ConnectorStage, ConnectorSupportSource } from './types';
        ...
        <section className={styles.detail}>
          ...
          <div className={styles.detailGrid}>
            ...
            <div className={styles.detailCard}>
              ...
              <div className={styles.detailCardText}>{getImplementationOwnerLabel(resolvedConnector.implementationOwner)}</div>
            </div>
