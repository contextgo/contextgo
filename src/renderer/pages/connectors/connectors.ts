...
const CONNECTOR_SUPPORT_SOURCES: Record<string, ConnectorSupportSource[]> = {
  'contextgo-clipboard': [
    {
      ...
      description: 'Clipboard is productized inside ContextGo through a managed observer wrapper and local store/collect flow.',
    },
    {
      kind: 'connector-repo',
      label: 'Connector Repository',
      url: 'https://github.com/contextgo/connector',
      description: 'The sibling connector repository provides the upstream clipboard observer and activity-model reference implementation.',
    },
  ],
  lark: [
    {
  ...
  'google-drive': [
    ...
    },
    {
      ...
      description: 'Official Google APIs for Go client repository, which is the planned SDK base for the Drive sidecar.',
    },
    {
      kind: 'contextgo-native',
      label: 'ContextGo Go Stub',
      url: 'https://contextgo.io',
      description: 'ContextGo currently ships a managed Go sidecar stub contract before the full Drive OAuth/files.list workflow is implemented.',
    },
  ],
};
  ...
  'google-sheets': [
    { kind: 'official-docs', label: 'Sheets API Reference', url: 'https://developers.google.com/workspace/sheets/api/reference/rest', description: 'Official Google Sheets API reference and OAuth guidance.' },
    { kind: 'official-sdk', label: 'google-api-go-client', url: 'https://github.com/googleapis/google-api-go-client', description: 'Official Go client base reused by the Workspace sidecars.' },
    { kind: 'contextgo-native', label: 'ContextGo Workspace Sidecar', url: 'https://contextgo.io', description: 'ContextGo mounts Google Sheets on top of the shared Workspace token cache.' },
  ],
  gmail: [
    { kind: 'official-docs', label: 'Gmail API Reference', url: 'https://developers.google.com/gmail/api/reference/rest', description: 'Official Gmail API reference for labels and mailbox metadata.' },
    { kind: 'official-sdk', label: 'google-api-go-client', url: 'https://github.com/googleapis/google-api-go-client', description: 'Official Go client base reused by the Workspace sidecars.' },
    { kind: 'contextgo-native', label: 'ContextGo Workspace Sidecar', url: 'https://contextgo.io', description: 'ContextGo mounts Gmail on top of the shared Workspace token cache.' },
  ],
  'google-calendar': [
    { kind: 'official-docs', label: 'Calendar API Reference', url: 'https://developers.google.com/workspace/calendar/api/v3/reference', description: 'Official Google Calendar API reference for calendar list and event metadata.' },
    { kind: 'official-sdk', label: 'google-api-go-client', url: 'https://github.com/googleapis/google-api-go-client', description: 'Official Go client base reused by the Workspace sidecars.' },
    { kind: 'contextgo-native', label: 'ContextGo Workspace Sidecar', url: 'https://contextgo.io', description: 'ContextGo mounts Google Calendar on top of the shared Workspace token cache.' },
  ],
...
const RAW_CONNECTORS: ConnectorDefinition[] = [
  {
    ...
    authType: 'native',
    stage: 'priority',
    summary: 'Space-owned clipboard activity connector with a managed observer, local event store, and collect workflow.',
  ...
  },
  {
    ...
    authType: 'oauth',
    stage: 'priority',
    summary: 'Managed Google Drive connector built around the official Drive API Go route and a ContextGo Go sidecar contract.',
    implementationOwner: 'hybrid',
  ...
  },
  {
    ...
    authType: 'oauth',
    stage: 'priority',
    summary: 'Managed Google Docs connector that reuses Google Workspace OAuth and a Go sidecar to list and sync Docs documents.',
    implementationOwner: 'hybrid',
  ...
  },
  {
    ...
    authType: 'oauth',
    stage: 'priority',
    summary: 'Managed Feishu OpenAPI connector that uses official Open Platform docs and the official lark-openapi-mcp runtime path.',
