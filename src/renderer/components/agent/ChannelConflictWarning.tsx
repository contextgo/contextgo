...
/**
 * Warning component when OpenClaw channel conflicts with ContextGo Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not ContextGo.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in ContextGo will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use ContextGo Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and ContextGo.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for ContextGo.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in ContextGo Channels and continue using OpenClaw's integration.
          </Paragraph>
