...
export type ResolvedSettingsTab = {
  ...
  /** Display name */
  name: string;
  /** Icon URL (contextgo-asset:// or undefined) */
  icon?: string;
  /** Content URL (contextgo-asset:// local asset or external https:// URL) */
  entryUrl: string;
 ...
 * - local entryPoint: validate path + convert to contextgo-asset:// URL
