...
export const ExtensionMetaSchema = z
  .object({
    ...
    /** P2: ContextGo core version compatibility */
    engine: z
      .object({
        contextgo: z
          .string()
          ...
          .optional()
          .describe('Compatible ContextGo core version range'),
      })
      .optional(),
    /**
    ...
    permissions: z
      .object({
        /** Read/write to ContextGo persistent storage */
...
/**
 * Product-supported preset agent types.
 * Legacy preset ids are still accepted by the schema via the free-form string branch below.
 */
export const PRESET_AGENT_TYPES = ['gemini', 'claude', 'codex', 'opencode'] as const;
