...
import { SessionPatternDetectionJobHandler } from './jobs/SessionPatternDetectionJobHandler';
...
const sessionPatternDetectionJobHandler = new SessionPatternDetectionJobHandler(contextVaultSyncService);
...
export const contextJobRunner = new ContextJobRunner(
  ...
  sessionPatternDetectionJobHandler,
