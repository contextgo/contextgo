 ...
 * Used by ScheduleService to avoid sending messages to busy conversations
 */
type IdleCallback = () => void;

export class ScheduleConversationGuard {
...
// Singleton instance
export const scheduleConversationGuard = new ScheduleConversationGuard();
