...
export function createPairingHelpCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '',
      '**What is pairing?**',
      'Pairing links your DingTalk account with the local ContextGo application.',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'ContextGo Assistant Help',
    text: [
      '### ContextGo Assistant Help',
      '',
      'A remote assistant to interact with ContextGo via DingTalk.',
      '',
      '**Common Actions:**',
