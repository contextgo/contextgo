...
- **Marker highlight** — for beyond-color emphasis, see [css-patterns.md](../effects/css-patterns.md)
...
- [css-patterns.md](../effects/css-patterns.md) — CSS+GSAP marker highlighting (deterministic, fully seekable)
