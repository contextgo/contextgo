...
Shader setup, WebGL init, capture, and fragment shaders are handled by `@hyperframes/shader-transitions` (`packages/shader-transitions/`). Read the package source for API details. Compositions using shaders must follow the CSS rules in [overview.md](overview.md) § "Shader-Compatible CSS Rules".
...
| -------------- | ---------------------------------------------------- | ------------------------------------------------ |
| Push           | Push slide, vertical push, elastic push, squeeze     | [css-push.md](./css-c/css-push.md)               |
| Radial / Shape | Circle iris, diamond iris, diagonal split            | [css-radial.md](./css-c/css-radial.md)           |
| 3D             | 3D card flip                                         | [css-3d.md](./css-a/css-3d.md)                   |
| Scale / Zoom   | Zoom through, zoom out                               | [css-scale.md](./css-c/css-scale.md)             |
| Dissolve       | Crossfade, blur crossfade, focus pull, color dip     | [css-dissolve.md](./css-a/css-dissolve.md)       |
| Cover          | Staggered blocks, horizontal blinds, vertical blinds | [css-cover.md](./css-a/css-cover.md)             |
| Light          | Light leak, overexposure burn, film burn             | [css-light.md](./css-b/css-light.md)             |
| Distortion     | Glitch, chromatic aberration, ripple, VHS tape       | [css-distortion.md](./css-b/css-distortion.md)   |
| Mechanical     | Shutter, clock wipe                                  | [css-mechanical.md](./css-b/css-mechanical.md)   |
| Grid           | Grid dissolve                                        | [css-grid.md](./css-b/css-grid.md)               |
| Other          | Gravity drop, morph circle                           | [css-other.md](./css-b/css-other.md)             |
| Blur           | Blur through, directional blur                       | [css-blur.md](./css-a/css-blur.md)               |
| Destruction    | Page burn                                            | [css-destruction.md](./css-a/css-destruction.md) |
