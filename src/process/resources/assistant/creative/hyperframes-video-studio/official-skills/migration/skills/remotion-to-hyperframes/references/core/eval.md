...
[fonts.md](../topics/fonts.md) covers how to mitigate (use Inter, load explicit
Google Fonts).
...
3. **Re-read the relevant reference.** [timing.md](../topics/timing.md) for
   spring/easing issues, [sequencing.md](../topics/sequencing.md) for scene
   boundary issues, [media.md](../topics/media.md) for asset loading issues.
