...
| `defaultProps={...}`                                 | `data-*` attributes on `#stage` (one per scalar prop). Nested objects/arrays — see [parameters.md](../topics/parameters.md) |
...
See [sequencing.md](../topics/sequencing.md) for nesting and stagger details.
...
See [timing.md](../topics/timing.md) — this is the highest-leverage section.
...
| `spring({frame, fps, config: {damping, stiffness, mass}})` | GSAP `back.out(N)` — see [timing.md](../topics/timing.md) for damping → overshoot table                            |
...
See [media.md](../topics/media.md) for trim, volume ramps, and decoder notes.
...
See [transitions.md](../topics/transitions.md).
...
| `springTiming({config})`                                                       | duration in seconds, ease `back.out` — see [timing.md](../topics/timing.md)                               |

## Lottie

See [lottie.md](../topics/lottie.md).
...
See [parameters.md](../topics/parameters.md).
