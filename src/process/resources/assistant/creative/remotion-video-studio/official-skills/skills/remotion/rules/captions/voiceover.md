...
Use ElevenLabs TTS to generate speech audio per scene, then use [`calculateMetadata`](../core/calculate-metadata.md) to dynamically size the composition to match the audio.
...
Use [`calculateMetadata`](../core/calculate-metadata.md) to measure the [audio durations](../tools/get-audio-duration.md) and set the composition length accordingly.
...
If the composition uses [`<TransitionSeries>`](../core/transitions.md), subtract the overlap from total duration: [../core/transitions.md#calculating-total-composition-duration](../core/transitions.md#calculating-total-composition-duration)

## Rendering audio in the component

See [audio.md](../media/audio.md) for more information on how to render audio in the component.

## Delaying audio start

See [audio.md#delaying](../media/audio.md#delaying) for more information on how to delay the audio start.
