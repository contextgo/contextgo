...
Use the [`getVideoDuration`](../tools/get-video-duration.md) and [`getVideoDimensions`](../tools/get-video-dimensions.md) skills to get the video duration and dimensions:
...
Use the [`getVideoDimensions`](../tools/get-video-dimensions.md) skill to get the video dimensions:
