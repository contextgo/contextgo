...
- identify which ContextGo primitive should own the capability
...
4. Call out blockers where external concepts depend on events ContextGo does not yet expose.
