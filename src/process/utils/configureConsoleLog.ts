 ...
 *   - macOS:   ~/Library/Logs/ContextGo/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\ContextGo\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/ContextGo/logs/YYYY-MM-DD.log
 *
