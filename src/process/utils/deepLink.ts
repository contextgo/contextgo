...
export const PROTOCOL_SCHEME = 'cgo';

/**
 * Parse a cgo:// URL into action and params.
 * Supports two formats:
 *   1. cgo://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. cgo://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
