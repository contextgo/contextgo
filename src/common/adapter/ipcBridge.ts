...
export const acpConversation = {
  ...
  configureManagedRuntimeModel: bridge.buildProvider<
    IBridgeResponse<import('../types/acpTypes').ManagedRuntimeModelConfigResult>,
    import('../types/acpTypes').ManagedRuntimeModelConfigParams
  >('acp.configure-managed-runtime-model'),
  listManagedRuntimeTokenGroups: bridge.buildProvider<
    IBridgeResponse<import('../types/acpTypes').ManagedRuntimeTokenGroupListResult>,
    import('../types/acpTypes').ManagedRuntimeTokenGroupListParams
  >('acp.list-managed-runtime-token-groups'),
  syncManagedRuntimeModelProvider: bridge.buildProvider<
    IBridgeResponse<import('../types/acpTypes').ManagedRuntimeModelProviderSyncResult>,
    import('../types/acpTypes').ManagedRuntimeModelProviderSyncParams
  >('acp.sync-managed-runtime-model-provider'),
  getLocalTokenUsage: bridge.buildProvider<
    IBridgeResponse<import('../types/acpTypes').LocalTokenUsageReport>,
    { forceRefresh?: boolean }
  >('acp.get-local-token-usage'),
