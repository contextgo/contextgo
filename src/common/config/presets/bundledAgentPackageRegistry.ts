...
import remotionVideoStudioManifestRaw from '@/process/resources/assistant/creative/remotion-video-studio/agent-package.json';
...
export const BUNDLED_AGENT_PACKAGE_DESCRIPTORS: readonly BundledAgentPackageDescriptor[] = [
  ...
  {
    resourceDir: 'src/process/resources/assistant/creative/remotion-video-studio',
    manifest: parseBundledManifest(
      remotionVideoStudioManifestRaw,
      'src/process/resources/assistant/creative/remotion-video-studio'
    ),
  },
  {
