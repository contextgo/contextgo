...
| ---------------------- | ------------------------------------------ | ------------------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------- |
| Electron app id        | `com.aionui.app`                           | `io.contextgo.app`                               | Migrate now | No installed-user compatibility requirement; should match the ContextGo brand and reverse-domain naming.                    |
