...
for f in ContextGo-1.0.0-win-x64.exe ContextGo-1.0.0-win-arm64.exe ContextGo-1.0.0-mac-x64.dmg ContextGo-1.0.0-mac-arm64.dmg ContextGo-1.0.0.deb ContextGo-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
