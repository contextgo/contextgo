...
# Linux
touch "$ARTIFACTS_DIR/linux-build/ContextGo-1.0.0.deb"
touch "$ARTIFACTS_DIR/linux-build/ContextGo-1.0.0-arm64.deb"
cat > "$ARTIFACTS_DIR/linux-build/latest-linux.yml" <<'EOF'
version: 1.0.0
files:
  - url: ContextGo-1.0.0.deb
