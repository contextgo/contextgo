...
const journalCopy: Record<SiteLocale, BlogJournalCopy> = {
  ...
  zh: {
    ...
    articleActionsBody:
      '这里负责讲清楚产品判断，文档负责提供结构化参考，版本历史负责说明真正已经交付了什么。',
  },
};
...
const fallbackSupplement: Record<SiteLocale, BlogArticleSupplement> = {
  en: {
    ...
    why:
      'ContextGo should publish writing that helps people operate the product with the same mental model the team is using internally.',
    relatedSlugs: [],
  },
  zh: {
    role: '编辑文章',
