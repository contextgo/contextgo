import type { BlogSection, SiteLocale } from './types';

const blogContent: Record<SiteLocale, BlogSection> = {
  en: {
    badge: 'Blog',
    ...
    entries: [
      {
        ...
        sections: [
          {
            heading: 'Why this product does not start from a blank chat box',
            paragraphs: [
      ...
      },
      {
        ...
        sections: [
          {
            heading: 'One release repository reduces ambiguity',
            paragraphs: [
          ...
          {
            heading: 'What belongs in the release repository',
            paragraphs: [
      ...
      },
      {
        ...
        sections: [
          {
            heading: 'Avoid describing mobile as a second execution host',
            paragraphs: [
          ...
          {
            heading: 'Why this matters for roadmap decisions',
            paragraphs: [
    ...
    entries: [
      {
        ...
        sections: [
          {
            heading: '为什么不从空白聊天框开始',
            paragraphs: [
              '通用聊天界面很容易演示，但在真实工作流里往往乏力，因为文件、文档、任务、历史和渠道仍然是散的。',
              'ContextGo 的核心观点是，一旦上下文层被接通，Agent 就不再只是孤立回答问题的助手，而开始成为现有工作流里的参与者。',
            ],
          },
          {
            heading: '这会直接改变产品设计',
            paragraphs: [
              '因此 connector、远程访问、云身份和 runtime 管理都不是边角功能，而是为了让上下文层在真实环境里可用而存在。',
            ],
          },
        ],
      },
...
export const getBlogSection = (locale: SiteLocale) => blogContent[locale];
