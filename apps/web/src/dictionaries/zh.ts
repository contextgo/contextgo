export const zh = {
  ...
  philosophy: {
    ...
    description_start: '把文件、文档、任务、对话和 Agent 放到同一个工作面里。',
    description_end: '这样 AI 才能继续读取、继续执行、继续协作。',
    points: [
      '在一个工作台里处理文件、文档、任务与对话',
      '桌面主机执行，网页与移动端远程接入',
      '把 Agent 发布到 Slack、Discord、Lark 与 Web',
      '围绕同一份上下文持续协作与交付',
    ],
    features: {
      private: {
        title: '连接真实上下文',
        desc: '把文件、知识、任务和历史状态接到一起，让 Agent 基于真实工作继续推进。',
      },
      editor: {
        title: '保留现有工具',
        desc: '不要求团队先迁移流程，先把现有目录、文档、聊天和工具接进来。',
      },
      connect: {
        title: '多入口协作',
        desc: '让 Agent 进入 Web、Slack、Discord、Lark 等入口，和人一起继续工作。',
      },
      manage: {
        title: '统一工作台',
        desc: '把上下文、运行时、自动化和交付入口放进同一个产品表面。',
      },
    },
  },
  connect: {
