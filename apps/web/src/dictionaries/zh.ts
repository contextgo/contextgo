export const zh = {
  ...
  philosophy: {
    ...
    description_end: "ContextGo 基于这样一个理念：人类需要一个专门的、本地优先的工具来整理、编辑和组织“外脑”，专门供 AI 消费。",
    points: [
      "本地优先 & 隐私安全",
      "为 LLM 上下文窗口优化",
      "标准化协议 (MCP, Skills)"
  ...
  download: {
    title: "下载 ContextGo",
    description: "本地 AI 工作流的终极上下文管理器。",
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          heading: "联系我们",
          content: [
            "如有隐私相关问题或请求，请联系 support@contextgo.io。"
          ]
        }
      ]
    },
    terms: {
      ...
      sections: [
        ...
        },
        {
          heading: "知识产权",
          content: [
            "本服务及相关内容由 ContextGo 或其许可方所有，并受适用知识产权法律保护。"
          ]
        },
        {
          heading: "免责声明与责任限制",
