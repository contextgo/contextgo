export const en = {
  ...
  hero: {
    title_start: 'Bring files, docs, and conversations into one',
    title_end: 'AI workbench.',
    description:
  ...
  philosophy: {
    ...
    description_start: 'Bring files, docs, tasks, conversations, and agent runtime into one operating surface.',
    description_end: 'That is how AI can keep reading, acting, and collaborating beyond a single prompt.',
    points: [
    ...
    features: {
      private: {
        ...
        desc: 'Connect files, knowledge, tasks, and working history so agents can continue from the real state of the job.',
      },
      editor: {
        title: 'Fits Your Stack',
        desc: 'Do not rebuild your workflow first. Start by connecting the directories, docs, chats, and tools teams already use.',
      },
      connect: {
        title: 'Multi-Surface Collaboration',
        desc: 'Bring agents into the web, Slack, Discord, Lark, and other working surfaces so people and AI can keep moving together.',
      },
      manage: {
        title: 'One Workbench',
        desc: 'Keep context, runtime access, automation, and delivery entry points inside one product surface.',
      },
    },
  },
  connect: {
    ...
    features: [
      {
        ...
        desc: 'Bring in folders, knowledge tools, communication systems, and structured data. No forced migration first.',
      },
      {
        title: 'Turn it into one context layer',
        desc: 'Turn scattered sources into one shared context surface for agents, automations, and review.',
      },
      {
        title: 'Reuse it everywhere downstream',
        desc: 'Connect once. Reuse everywhere. Chat, retrieval, publishing, and sync all start from the same context.',
      },
    ],
    panel_label: 'Context pipeline',
    panel_title: 'Connectors help ContextGo understand the work first.',
    panel_body:
    ...
    workflow: [
      {
        title: 'Ingest once',
        desc: 'Folders, notes, cloud docs, chat systems, and structured stores enter through connectors.',
      },
      {
        title: 'Normalize once',
        desc: 'Different sources become one consistent surface for search, review, ranking, and delivery.',
      },
      {
        title: 'Route everywhere',
        desc: 'The same context can then feed AI sessions, remote clients, and publishing flows.',
      },
    ],
    ...
    use_cases: [
      {
        ...
        desc: 'Bring PRDs, docs, changelogs, tickets, and internal notes together so product context stops scattering.',
      },
      {
        title: 'Connect team memory',
        desc: 'Pull decisions back out of chats, meetings, wikis, and shared drives before they vanish into history.',
      },
      {
        title: 'Connect operational data',
        desc: 'Turn tables, dashboards, exports, and structured records into reusable context instead of pasting snapshots everywhere.',
      },
    ],
  },
  download: {
    center_badge: 'Choose Your Device',
    title: 'Get ContextGo',
    description:
    ...
    version_pending: 'Not Available Yet',
    updated_label: 'Released',
    source_label: 'Source',
    source_none: 'Not Available',
    checksum_label: 'File Verification',
    checksum_available: 'Verified',
    checksum_missing: 'Pending',
    manifest_note: 'Install details last updated: {{date}}',
    manifest_pending: 'Updates with each release',
    system_requirements_label: 'Requirements',
    permissions_label: 'Install Notes',
    asset_block_label: 'Files',
    asset_file_label: 'File',
    asset_size_label: 'Size',
    asset_unknown: 'Unknown',
    sha256_label: 'Checksum',
    sha256_missing: 'Pending',
    no_direct_asset: 'Direct download not available yet.',
    source_release: 'Release',
    source_tag: 'Tag',
    release_notes_action: 'Release Notes',
    release_source_note: 'Notes and downloads stay in sync with the official release page',
    note_release: {
      title: 'Desktop, Linux, And Android',
      body: 'Direct downloads come first. File details and verification stay here.',
    },
    note_ios: {
      title: 'iPhone / iPad',
      body: 'Go to the right official path, whether that is the App Store, TestFlight, or the web.',
    },
    note_harmony: {
      title: 'HarmonyOS',
      body: 'Start with the official distribution path. Direct packages can appear here later.',
    },
  },
  footer: {
    tagline: 'Connect real work and keep agents collaborating.',
