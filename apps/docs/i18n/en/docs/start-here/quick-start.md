...
description: Set up your first desktop host, connect one ready runtime, and complete one real task before adding more complexity.
---
...
Start with one runtime that is truly:
...
- summarizing a set of materials
- processing a project issue
