...
```text
GCP_PROJECT_ID=infermesh
GCP_COMPUTE_ZONE=asia-east2-a
GCP_COMPUTE_VM_INSTANCE=api-hk-a
GCP_WORKLOAD_IDENTITY_PROVIDER=projects/22199848375/locations/global/workloadIdentityPools/github-actions/providers/contextgo-contextgo
GCP_SERVICE_ACCOUNT_EMAIL=github-actions-deployer@infermesh.iam.gserviceaccount.com
```
